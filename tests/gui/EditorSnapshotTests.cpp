...
// GUI smoke tests for the M3 photoreal editor (src/PluginEditor.h,
// src/gui/), ported from the suite's M3 pilot
// (basilica-audio/silentium's tests/gui/EditorSnapshotTests.cpp).
